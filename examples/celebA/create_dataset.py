...
class CELEBA(data.Dataset):
    def __init__(self, root, split="train", is_transform=False, img_size=(64, 64), augmentations=None): # 32, 32
        """__init__
        :param root:
        :param split:
        :param is_transform:
        ...
        self.all_files = glob.glob(self.root + '/Img/img_align_celeba/*.jpg')  # *1234*
