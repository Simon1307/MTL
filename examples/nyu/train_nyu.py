...
def parse_args(parser):
    ...
    parser.add_argument('--dataset_path', default='/home/kus1rng/data/nyuv2', type=str, help='dataset path')
...
def main(params):
    ...
    # bookkeeping
    exp_name = get_exp_name(params, optim_param, scheduler_param, kwargs, dataset="NYUv2")
    ...
    if params.arch == 'MTAN':
        ...
        model = model_class(tasks=list(task_dict.keys()), weighting=params.weighting, num_classes=[13, 1, 3],
    ...
    NYUmodel.train(nyuv2_train_loader, nyuv2_test_loader)
